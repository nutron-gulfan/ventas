...
const MessangerLayout = ({ user }) => {
    ...
    const addFriend = async (e) => {
        ...
        try {
            ...
            const addingFriend = await axios.post("https://git.heroku.com/ventas-v1.git/users/follow", infoFriend);
    ...
    const removeFriend = async (friendToremove) => {
        ...
        try {
            ...
            const removingFriend = await axios.post("https://git.heroku.com/ventas-v1.git/users/unfollow", infoFriend);
            socket.current.emit("sendMessage", {
                senderEmail: user.emails[0].value,
    ...
    const addChannel = async (e) => {
        ...
        const addingChannel = await axios.post("https://git.heroku.com/ventas-v1.git/Channels/create", infoFriend);
    ...
    const deleteChannel = async (chanelToDelete, channelName) => {
        ...
        const deletingChannel = await axios.post("https://git.heroku.com/ventas-v1.git/Channels/delete", infoFriend);
    ...
    const handleSubmit = async (e) => {
        ...
        if (file) {
            ...
            try {
                const upld = await axios.post("https://git.heroku.com/ventas-v1.git/upload", data);
                if (upld.status === 200) {
                    ...
                    const message = {
                        ...
                        text: { type: fileExt, src: "https://git.heroku.com/ventas-v1.git/images/" + fileName, message: newMessage }
                    };
                    ...
                    const sendMessage = await axios.post("https://git.heroku.com/ventas-v1.git/message/", message);
            ...
            try {
                ...
                if (upld.status === 200) {
                    ...
                    const message = {
                        ...
                        text: { type: fileExt, src: "https://git.heroku.com/ventas-v1.git/images/" + fileName, message: newMessage, createdAt: myDate }
                    };
                    // console.log(message.text);
                    ...
                    const sendGroupconversation = await axios.post("https://git.heroku.com/ventas-v1.git/channels/sendMessage", message);
    ...
    useEffect(() => {
        const getAllUsers = async () => {
            try {
                ...
                const res = await axios.post("https://git.heroku.com/ventas-v1.git/users/all", giveMyEmail);
        ...
        const getFriends = async () => {
            try {
                ...
                const res = await axios.post("https://git.heroku.com/ventas-v1.git/users/friends", giveMyEmail);
                setFriends(res.data);
        ...
        const getChannels = async () => {
            try {
                ...
                const res = await axios.post("https://git.heroku.com/ventas-v1.git/channels/all", giveMyEmail);
        ...
        const fetchConversation = async () => {
            if (currentChat.email) {
                try {
                    ...
                    const checkconv = await axios.post("https://git.heroku.com/ventas-v1.git/conversation/find", conversation)
                    ...
                    if (result) {
                        ...
                        const savedConv = await axios.post("https://git.heroku.com/ventas-v1.git/conversation/create", conversation)
    ...
    useEffect(() => {
        if (currentChat.email) {
            ...
            const getAllmessages = async () => {
                const res = await axios.post("https://git.heroku.com/ventas-v1.git/message/fetchMessage", fetchThisConv);
    ...
    useEffect(() => {
        if (currentGroupChat._id) {
            ...
            const getAllGroupMessages = async () => {
                const res = await axios.post("https://git.heroku.com/ventas-v1.git/channels/fetchMessages", fetchGroupConv);
    ...
    const addMemberToChannel = async (emailToAdd, channelToAdd) => {
        ...
        const addMemberNow = await axios.post("https://git.heroku.com/ventas-v1.git/channels/addMemberNow", sendInfo);
    ...
    const removeMemberFromChannel = async (emailToRemove, channelFromRmove) => {
        ...
        const removeMemberNow = await axios.post("https://git.heroku.com/ventas-v1.git/channels/removeMemberNow", sendInfo);
